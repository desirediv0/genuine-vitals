  ...
  try {
    ...
    if (faqs.length > 0) {
      return res.status(200).json(
        new ApiResponsive(200, {
          faqs,
          metaTitle: "Frequently Asked Questions | GenuinevVitals",
          metaDescription:
  ...
  try {
    ...
    if (contactContent) {
      const contactData = {
        ...
        socialLinks: {
          facebook: "https://facebook.com/GenuinevVitals",
          instagram: "https://instagram.com/GenuinevVitals",
          twitter: "https://twitter.com/GenuinevVitals",
        },
      };
    ...
    const contactInfo = {
      ...
      metaTitle: "Contact Us | GenuinevVitals",
      metaDescription:
