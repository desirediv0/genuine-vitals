  ...
  try {
    ...
    if (faqs.length > 0) {
      return res.status(200).json(
        new ApiResponsive(200, {
          faqs,
          metaTitle: "Frequently Asked Questions | Genuine Vitals",
          metaDescription:
...
const getContactInfo = asyncHandler(async (req, res) => {
  try {
    ...
    const contactInfo = {
      ...
      metaTitle: "Contact Us | Genuine Vitals",
      metaDescription:
