            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <Card>
                    ...
                    <CardContent>
                        <div
                            {...getDesktopRootProps()}
                            className={`border-2 border-dashed rounded-lg p-8 text-center cursor-pointer transition-colors ${isDesktopDragActive
                ...
                <Card>
                    ...
                    <CardContent>
                        <div
                            {...getMobileRootProps()}
                            className={`border-2 border-dashed rounded-lg p-8 text-center cursor-pointer transition-colors ${isMobileDragActive
                                ? "border-primary bg-primary/5"
                                : "border-gray-300 hover:border-primary"
                                }`}
                        >
